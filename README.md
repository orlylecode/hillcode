...
To build the final jar and optimize the hillcode application for production, run:
...
Then navigate to [http://localhost:6664](http://localhost:6664) in your browser.
